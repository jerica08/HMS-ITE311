       ...
       <nav class="sidebar">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="<?= base_url('admin/resources') ?>" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('admin/audit-logs') ?>" class="nav-link active">
        ...
        <main class="content">
            ...
            <div class="audit-section">
                <div class="section-header">
                    ...
                    <div class="section-title">Filter Audit Logs</div>
                </div>
                ...
                <div class="filter-row">
                    ...
                    <div class="filter-group">
                        <label>User</label>
                        <input type="text" class="form-input" placeholder="Search by user..." id="userFilter">
                    </div>
                    <div class="filter-group">
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-success btn-small" onclick="exportLogs('csv')">
                        <i class="fas fa-file-csv"></i> Export CSV
                    </button>
                    <button class="btn btn-secondary btn-small" onclick="exportLogs('pdf')">
                        <i class="fas fa-file-pdf"></i> Export PDF
                    </button>
                    <button class="btn btn-warning btn-small" onclick="archiveLogs()">
            ...
            const logDetails = {
                log1: {
                    ...
                    content: `
                        ...
                        <p><strong>Timestamp:</strong> 2024-09-02 09:48:00</p>
                ...
                log2: {
                    ...
                    content: `
                        ...
                        <p><strong>Timestamp:</strong> 2024-09-02 09:45:00</p>
