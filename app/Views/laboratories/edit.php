                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Edit Laboratory Information</h5>
                            </div>
                            <div class="card-body">
                                <form action="/laboratories/update/<?= $laboratory['id'] ?>" method="POST">
                                    <?= csrf_field() ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="capacity" name="capacity" 
                                                       value="<?= old('capacity', $laboratory['capacity']) ?>" min="1" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="equipment" name="equipment" rows="3" required><?= old('equipment', $laboratory['equipment']) ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="3"><?= old('description', $laboratory['description'] ?? '') ?></textarea>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8"><?= $laboratory['id'] ?></dd>
                                    
                                    <dt class="col-sm-4">Name:</dt>
                                    <dd class="col-sm-8"><?= esc($laboratory['name']) ?></dd>
                                    
                                    <dt class="col-sm-4">Location:</dt>
                                    <dd class="col-sm-8"><?= esc($laboratory['location']) ?></dd>
                                    
                                    <dt class="col-sm-4">Capacity:</dt>
                                    <dd class="col-sm-8"><?= $laboratory['capacity'] ?></dd>
                                    
                                    <dt class="col-sm-4">Status:</dt>
                                    <dd class="col-sm-8">
                                        <span class="badge bg-<?= $laboratory['status'] === 'active' ? 'success' : ($laboratory['status'] === 'inactive' ? 'danger' : 'warning') ?>">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <a href="/laboratories/delete/<?= $laboratory['id'] ?>" class="btn btn-outline-danger" 
                                       onclick="return confirm('Are you sure you want to delete this laboratory? This action cannot be undone.')">
