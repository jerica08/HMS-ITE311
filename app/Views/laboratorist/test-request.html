...
<html lang="en">
  <head>
    ...
    <title>Laboratory - Test Requests - HMS</title>
  ...
  <body class="lab-theme">
    ...
    <div class="main-container">
      ...
      <main class="content">
        ...
        <div class="quick-actions">
          <a href="#" class="btn btn-primary"><i class="fas fa-plus"></i> New Test Request</a>
          <a href="#" class="btn btn-secondary"><i class="fas fa-file-import"></i> Import Orders</a>
        </div>

        <!-- Test Request Form -->
        <div class="table-container" style="margin-top: 1.5rem">
          <h3 style="margin-bottom: 1rem">Create Test Request</h3>
          <form id="test-request-form">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem">
              ...
              <div>
                <label for="physician" style="display:block; font-weight:600; margin-bottom: .5rem">Ordering Physician</label>
                <input id="physician" name="physician" type="text" placeholder="e.g., Dr. Santos" style="width:100%; padding:.75rem; border:1px solid #e2e8f0; border-radius:8px" />
              </div>
            </div>
            <div style="margin-top: 1rem">
              <label for="notes" style="display:block; font-weight:600; margin-bottom: .5rem">Clinical Notes</label>
              <textarea id="notes" name="notes" rows="4" placeholder="Add relevant clinical information..." style="width:100%; padding:.75rem; border:1px solid #e2e8f0; border-radius:8px; resize: vertical"></textarea>
            </div>
        ...
        <div class="table-container" style="margin-top: 2rem">
          <h3 style="margin-bottom: 1rem">Pending Test Requests</h3>
          <table class="table">
            <thead>
              <tr>
                <th>Sample ID</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>David Lee</td>
                <td>Lipid Panel</td>
                <td><span class="badge badge-success">Routine</span></td>
                <td>10:05 AM</td>
                <td><span class="badge badge-info">Queued</span></td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <a href="#" class="btn btn-danger" style="padding: 0.3rem 0.8rem; font-size: 0.8rem">Process Now</a>
                </td>
              </tr>
            </tbody>
          </table>
    ...
    <script>
      ...
      document.getElementById('test-request-form').addEventListener('submit', function (e) {
        e.preventDefault();
        alert('Test request submitted (demo). Integrate with backend to save.');
        this.reset();
      });
    </script>
  </body>
